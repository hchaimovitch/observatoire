...
import jsonInitCitoy from './init-citoy.json';
...
class Map extends React.Component {
    ...
    componentDidMount() {
       ...
       this.map = new Datamap({
        element: document.getElementById("container"),
        projection: 'mercator', //projection: 'equirectangular', //style of projection to be used. try "mercator"
        fills: {
          defaultFill: "#ABDDA4",
        ...
        // setProjection: setProjection, //returns a d3 path and projection function
...
/*
        function getDataFromJson(){
            ...
            .then(json => {
              console.log("2. json" + JSON.stringify(json))
              this.setState({
                data: json,
                //animation: animation(json)
              });
